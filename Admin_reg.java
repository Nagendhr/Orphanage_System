...
public class Admin_reg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon("C:\\Users\\Sharmila\\OneDrive\\Documents\\Screenshot 2023-11-21 120133.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/orphanage","root","admin");
            PreparedStatement st=con.prepareStatement("insert into admin_reg1(name,address,contact,username,password)values(?,?,?,?,?)");
            st.setString(1,name);
